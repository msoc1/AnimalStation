...
//        Translations.getTranslations();
        ...
        ArrayList<String> trNew = Translations.getTranslationsNew(AnimalStation.getContext());
        ...
        animals.add(new Animal(R.drawable.dog_icon, R.drawable.dog1, R.drawable.dog2, R.drawable.dog3,
                ...
                R.drawable.dog9, R.drawable.dog10, R.raw.dog1, R.raw.dog2, R.raw.dog3, trNew.get(0).toUpperCase(),
                R.drawable.dog_black, R.drawable.meadow2, R.drawable.dog_big));
        ...
        animals.add(new Animal(R.drawable.cat_icon, R.drawable.cat1, R.drawable.cat2, R.drawable.cat3,
                ...
                R.drawable.cat9, R.drawable.cat10, R.raw.cat1, R.raw.cat2, R.raw.cat3, trNew.get(1).toUpperCase(),
                R.drawable.cat_black, R.drawable.island, R.drawable.cat_big));
        ...
        animals.add(new Animal(R.drawable.cow_icon, R.drawable.krowa1, R.drawable.krowa2, R.drawable.krowa3,
                ...
                R.drawable.krowa9, R.drawable.krowa10, R.raw.cow1, R.raw.cow2, R.raw.cow3, trNew.get(2).toUpperCase(),
                R.drawable.cow_black, R.drawable.meadow, R.drawable.cow_big));
        ...
        animals.add(new Animal(R.drawable.horse_icon, R.drawable.kon1, R.drawable.kon2, R.drawable.kon3,
                ...
                R.drawable.kon9, R.drawable.kon10, R.raw.horse1, R.raw.horse2, R.raw.horse3, trNew.get(3).toUpperCase(),
                R.drawable.horse_black, R.drawable.liscie, R.drawable.horse_big));
        ...
        animals.add(new Animal(R.drawable.pig_icon, R.drawable.swinka1, R.drawable.swinka2, R.drawable.swinka3,
                ...
                R.drawable.swinka9, R.drawable.swinka10, R.raw.pig1, R.raw.pig2, R.raw.pig3, trNew.get(4).toUpperCase(),
                R.drawable.pig_black, R.drawable.meadow, R.drawable.pig_big));
        ...
        animals.add(new Animal(R.drawable.goat_icon, R.drawable.koza1, R.drawable.koza2, R.drawable.koza3,
                ...
                R.drawable.koza9, R.drawable.koza10, R.raw.goat1, R.raw.goat2, R.raw.goat3, trNew.get(5).toUpperCase(),
                R.drawable.goat_black, R.drawable.liscie, R.drawable.goat_big));

        /*  fox */
        animals.add(new Animal(R.drawable.fox_icon, R.drawable.lis1, R.drawable.lis2, R.drawable.lis3,
                R.drawable.lis4, R.drawable.lis5, R.drawable.lis6, R.drawable.lis7, R.drawable.lis9,
                R.drawable.lis9, R.drawable.lis10, R.raw.for1, R.raw.fox2, R.raw.fox3, trNew.get(6).toUpperCase(),
                R.drawable.fox_black, R.drawable.meadow, R.drawable.fox_big));
        ...
        animals.add(new Animal(R.drawable.sheep_icon, R.drawable.owca1, R.drawable.owca2, R.drawable.owca3,
                ...
                R.drawable.owca9, R.drawable.owca10, R.raw.owca1, R.raw.owca2, R.raw.owca3, trNew.get(7).toUpperCase(),
                R.drawable.sheep_black, R.drawable.meadow2, R.drawable.sheep_big));
        ...
        animals.add(new Animal(R.drawable.chicken_icon, R.drawable.kura1, R.drawable.kura2, R.drawable.kura3,
                ...
                R.drawable.kura9, R.drawable.kura10, R.raw.chicken1, R.raw.chicken2, R.raw.chicken3, trNew.get(8).toUpperCase(),
                R.drawable.chicken_black, R.drawable.meadow, R.drawable.chicken_big));
        ...
        animals.add(new Animal(R.drawable.owl_icon, R.drawable.owl1, R.drawable.owl2, R.drawable.owl3,
                ...
                R.drawable.owl9, R.drawable.owl10, R.raw.owl1, R.raw.owl2, R.raw.owl3, trNew.get(9).toUpperCase(),
                R.drawable.owl_black, R.drawable.jungle, R.drawable.owl_big));
        ...
        animals.add(new Animal(R.drawable.elephant_icon, R.drawable.slon1, R.drawable.slon2, R.drawable.slon3,
                ...
                R.drawable.slon9, R.drawable.slon10, R.raw.elephant1, R.raw.elephant2, R.raw.elephant3, trNew.get(10).toUpperCase(),
                R.drawable.elephant_black, R.drawable.savanna, R.drawable.elephatn_big));

        /*  giraffe */
        animals.add(new Animal(R.drawable.giraffe_icon, R.drawable.zyrafa1, R.drawable.zyrafa2, R.drawable.zyrafa3,
                R.drawable.zyrafa4, R.drawable.zyrafa5, R.drawable.zyrafa6, R.drawable.zyrafa7, R.drawable.zyrafa8,
                R.drawable.zyrafa9, R.drawable.zyrafa10, R.raw.giraffe1, R.raw.giraffe2, R.raw.giraffe3, trNew.get(11).toUpperCase(),
                R.drawable.giraffe_black, R.drawable.savanna, R.drawable.giraffe_big));
        ...
        animals.add(new Animal(R.drawable.lion_icon, R.drawable.lew1, R.drawable.lew2, R.drawable.lew3,
                ...
                R.drawable.lew9, R.drawable.lew10, R.raw.lion1, R.raw.lion2, R.raw.lion3, trNew.get(12).toUpperCase(),
                R.drawable.lino_black, R.drawable.savanna, R.drawable.lion_big));
        ...
        animals.add(new Animal(R.drawable.tiger_icon, R.drawable.tygrys1, R.drawable.tygrys2, R.drawable.tygrys3,
                ...
                R.drawable.tygrys9, R.drawable.tygrys10, R.raw.tiger1, R.raw.tiger2, R.raw.tiger3, trNew.get(13).toUpperCase(),
                R.drawable.tiger_black, R.drawable.jungle, R.drawable.tiger_big));
        ...
        animals.add(new Animal(R.drawable.rhino_icon, R.drawable.noso1, R.drawable.noso2, R.drawable.noso3,
                ...
                R.drawable.noso9, R.drawable.noso10, R.raw.rhino1, R.raw.rhino2, R.raw.rhino3, trNew.get(14).toUpperCase(),
                R.drawable.rhino_black, R.drawable.savanna, R.drawable.rhino_big));
        ...
        animals.add(new Animal(R.drawable.penguin_icon, R.drawable.ping1, R.drawable.ping2, R.drawable.ping3,
                ...
                R.drawable.ping9, R.drawable.ping10, R.raw.penguin, R.raw.penguin2, R.raw.penguin23, trNew.get(15).toUpperCase(),
                R.drawable.penguin_black, R.drawable.ice, R.drawable.penguin_big));
        ...
        animals.add(new Animal(R.drawable.bear_icon, R.drawable.mis1, R.drawable.mis2, R.drawable.mis3,
                ...
                R.drawable.mis9, R.drawable.mis10, R.raw.bear1, R.raw.bear2, R.raw.bear3, trNew.get(16).toUpperCase(),
                R.drawable.bear_black, R.drawable.forrest2, R.drawable.bear_big));
        ...
        animals.add(new Animal(R.drawable.panda_icon, R.drawable.panda1, R.drawable.panda2, R.drawable.panda3,
                ...
                R.drawable.panda9, R.drawable.panda10, R.raw.panda1, R.raw.panda2, R.raw.panda3, trNew.get(17).toUpperCase(),
                R.drawable.panda_black, R.drawable.forrest3, R.drawable.panda_big));
        ...
        animals.add(new Animal(R.drawable.monkey_icon, R.drawable.malpa1, R.drawable.malpa2, R.drawable.malpa3,
                ...
                R.drawable.malpa9, R.drawable.malpa10, R.raw.monkey3, R.raw.monkey1, R.raw.monkey2, trNew.get(18).toUpperCase(),
                R.drawable.monkey_black, R.drawable.jungle, R.drawable.monkey_big));
        ...
        animals.add(new Animal(R.drawable.hippo_icon, R.drawable.hippo1, R.drawable.hippo2, R.drawable.hippo3,
                ...
                R.drawable.hippo9, R.drawable.hippo10, R.raw.hippo1, R.raw.hippo2, R.raw.hippo3, trNew.get(19).toUpperCase(),
                R.drawable.hippo_black, R.drawable.forrest2, R.drawable.hippo_big));

        /*  kangaroo */
        animals.add(new Animal(R.drawable.kangaroo_icon, R.drawable.kangaroo1, R.drawable.kangaroo2, R.drawable.kangaroo3,
                R.drawable.kangaroo4, R.drawable.kangaroo5, R.drawable.kangaroo6, R.drawable.kangaroo7, R.drawable.kangaroo8,
                R.drawable.kangaroo9, R.drawable.kangaroo10, R.raw.kangaroo1, R.raw.kangaroo2, R.raw.kangaroo3, trNew.get(20).toUpperCase(),
                R.drawable.kangaroo_black, R.drawable.island, R.drawable.kangaroo_big));
        ...
        animals.add(new Animal(R.drawable.dolphin_icon, R.drawable.dolphin1, R.drawable.dolphin2, R.drawable.dolphin3,
                ...
                R.drawable.dolphin9, R.drawable.dolphin10, R.raw.dolphin1, R.raw.dolphin2, R.raw.dolphin3, trNew.get(21).toUpperCase(),
                R.drawable.dolphin_black, R.drawable.ocean, R.drawable.dolphin_big));

        /*  rabbit */
        animals.add(new Animal(R.drawable.rabbit_icon, R.drawable.rabbit1, R.drawable.rabbit2, R.drawable.rabbit3,
                R.drawable.rabbit4, R.drawable.rabbit5, R.drawable.rabbit6, R.drawable.rabbit7, R.drawable.rabbit8,
                R.drawable.rabbit9, R.drawable.rabbit10, R.raw.rabbit1, R.raw.rabbit2, R.raw.rabbit3, trNew.get(22).toUpperCase(),
                R.drawable.rabbit_black, R.drawable.meadow, R.drawable.rabbit_big));
        ...
        animals.add(new Animal(R.drawable.koala_icon, R.drawable.koala1, R.drawable.koala2, R.drawable.koala3,
                ...
                R.drawable.koala9, R.drawable.koala10, R.raw.koala1, R.raw.koala2, R.raw.koala3, trNew.get(23).toUpperCase(),
                R.drawable.koala_black, R.drawable.jungle, R.drawable.koala_big));
