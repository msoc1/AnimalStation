...
public class AnimalsToUse {
    ...
    public static List<Animal> getAnimals() {
        ...
        animals.add(new Animal(R.drawable.fox_icon, R.drawable.lis1, R.drawable.lis2, R.drawable.lis3,
                ...
                R.drawable.lis9, R.drawable.lis10, R.raw.for1, R.raw.fox2, R.raw.fox3, Translations.getTranslations().get(6).toUpperCase(),
                Voices.getVoices().get(6), R.drawable.fox_black, R.drawable.meadow, R.drawable.fox_big));
        ...
        animals.add(new Animal(R.drawable.giraffe_icon, R.drawable.zyrafa1, R.drawable.zyrafa2, R.drawable.zyrafa3,
                ...
                R.drawable.zyrafa9, R.drawable.zyrafa10, R.raw.giraffe1, R.raw.giraffe2, R.raw.giraffe3, Translations.getTranslations().get(11).toUpperCase(),
                Voices.getVoices().get(11), R.drawable.giraffe_black, R.drawable.savanna, R.drawable.giraffe_big));
        ...
        animals.add(new Animal(R.drawable.bear_icon, R.drawable.mis1, R.drawable.mis2, R.drawable.mis3,
                ...
                Voices.getVoices().get(16), R.drawable.bear_black, R.drawable.forrest2, R.drawable.bear_big));
        ...
        animals.add(new Animal(R.drawable.kangaroo_icon, R.drawable.kangaroo1, R.drawable.kangaroo2, R.drawable.kangaroo3,
                ...
                R.drawable.kangaroo9, R.drawable.kangaroo10, R.raw.kangaroo1, R.raw.kangaroo2, R.raw.kangaroo3, Translations.getTranslations().get(20).toUpperCase(),
                Voices.getVoices().get(20), R.drawable.kangaroo_black, R.drawable.island, R.drawable.kangaroo_big));
        ...
        animals.add(new Animal(R.drawable.rabbit_icon, R.drawable.rabbit1, R.drawable.rabbit2, R.drawable.rabbit3,
                ...
                R.drawable.rabbit9, R.drawable.rabbit10, R.raw.rabbit1, R.raw.rabbit2, R.raw.rabbit3, Translations.getTranslations().get(22).toUpperCase(),
                Voices.getVoices().get(22), R.drawable.rabbit_black, R.drawable.meadow, R.drawable.rabbit_big));
